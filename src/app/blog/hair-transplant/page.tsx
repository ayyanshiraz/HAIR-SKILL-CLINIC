...
// Exactly 3 levels up: (hair-transplant -> blog -> app -> src) then into components
import BlogHairTransplantClient from "../../../components/BlogHairTransplantClient";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.almadinahijamacenter.com/blog/hair-transplant",
...
export default function BlogHairTransplantPage() {
  return <BlogHairTransplantClient />;
}