...
export default function BlogHairLossClient() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const textMessage = `Hello! I would like to get a free consultation from the Hair Loss Blog Category.\n\n*Name*: ${fullName}\n*Email*: ${email}\n*Phone*: ${selectedCountry.dial} ${phone}`;
  ...
  // --- STRICTLY TWO POSTS (Verbatim from reference screenshot) ---
  const hairLossPosts: BlogPost[] = [
    {
      ...
      >
        <div className="max-w-[1300px] mx-auto relative">
          ...
          <div className="text-xs font-black uppercase tracking-widest text-black mb-3 flex items-center gap-2 justify-start">
            ...
            <span>/</span>
            <span className="text-[#772424]">Hair Loss</span>
          </div>
          
          {/* Title independently centered */}
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="w-full lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-8">
              {hairLossPosts.map((post, idx) => (
                ...
                >
                  <Link href={post.link} className="flex flex-col flex-1 h-full block cursor-pointer">
              ...
              <div className="bg-[#772424] text-white rounded-3xl p-8 shadow-2xl relative w-full border border-[#8c2a2a]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <input type="checkbox" id="lossPrivacy" required defaultChecked className="w-4 h-4 accent-[#C5A059] rounded cursor-pointer" />
                    <label htmlFor="lossPrivacy" className="text-xs text-white/80 cursor-pointer">
