            ...
            >
              {cases.map((c, idx) => (
                <motion.div 
                  ...
                  className={`bg-[#772424] rounded-3xl p-3 flex flex-col shadow-lg cursor-pointer transition-transform duration-300 hover:-translate-y-2 select-none group/card`}
                >
                  {/* Image Wrapper */}
