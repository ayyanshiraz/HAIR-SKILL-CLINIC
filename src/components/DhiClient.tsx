            ...
            <div className="w-full lg:w-2/3 block">
              ...
              <motion.div initial="hidden" animate="visible" variants={fadeUp} className="mb-12 flex flex-col gap-6">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  DHI (Direct Hair Implantation) is one of the most advanced hair transplant techniques available today. Using a specialized implantation tool hair follicles are placed directly into the recipient area with exceptional precision and control.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424] flex flex-col gap-4">
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    DHI is designed to provide a comfortable direct hair implantation recovery time with minimal downtime. In most cases patients only require a short course of prescribed medication for approximately one month following the procedure. No additional treatments such as PRP are routinely required.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-12 flex flex-col gap-6 pt-8 border-t border-gray-200">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  Many people discover a DHI hair transplant Pakistan when they start searching for a method that feels gentler more controlled and more focused on natural angles. DHI often appears in headlines beside promises of no incisions fast healing and perfect density which can leave patients confused. At Hair Skill Clinic our job is to cut through the noise and give you a clear explanation of what a DHI hair transplant in Pakistan can truly deliver and when it is the right choice for you.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  DHI is not magic. It is a technique built around the DHI Choi pen technique which helps your surgeon place each graft with refined depth and direction without creating channels first. This can support softer hairlines clean transitions and smoother blending in areas where precision matters most. Patients searching for a DHI hair transplant in Lahore usually want exactly that: natural detail not overpromised density.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  For those seeking trustworthy guidance direct hair implantation at Hair Skill is built on surgeon led planning careful graft handling and a philosophy that respects both aesthetics and donor preservation.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                  Our lead surgical specialists often say that DHI is a precision tool. It shines when you use it with intention not as a trend.
                </p>
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  If you want a natural looking result that blends seamlessly with your existing hair DHI can be the right choice. At Hair Skill Clinic DHI is performed only by experienced surgeons who understand the balance between precision density and long term donor health. You feel guided supported and fully informed from the first message to your last follow up. If you are looking for the best DHI hair transplant clinic near me our team is ready to assist you.
                </p>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  People searching for what is DHI technique hair transplant usually want a simple honest explanation. DHI stands for Direct Hair Implantation. It uses a Choi implanter pen to place each graft directly into the scalp without creating channels beforehand.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    ...
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed">During a DHI hair transplant Pakistan grafts are extracted using standard FUE techniques. Instead of opening channels the surgeon loads each graft into the Choi pen. With a gentle press the pen implants the follicle exactly where it needs to sit. Placement and channel opening happen in one movement. This reduces handling time and helps the graft settle more naturally.</p>
                  </div>
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">DHI vs Sapphire FUE and When DHI Shines</h3>
                    ...
                    <div className="space-y-1 ml-2 mb-4">
                      {["Soft natural hairlines", "Temples and peaks", "Small gaps", "No shave hair transplant Lahore cases", "Womens hairlines"].map((item, i) => (
                    ...
                    <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                      Our attending physicians note that DHI helps when detail matters. The method follows the design not the other way around.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  People searching for a DHI hair transplant Pakistan usually fall into two groups. Some want a premium method that feels gentle and precise. Others want clarity about whether DHI is truly better or just heavily marketed.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  Pakistan became one of the most trusted destinations for DHI because experienced surgeons competitive package tiers and a well developed medical care system come together in one place. However not every clinic uses DHI the same way. At Hair Skill the method is chosen with intention not as a blanket solution.
                </p>
                ...
                <div className="space-y-6 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Why Hair Skill stands out and Patient appreciation</h3>
                    ...
                    <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                      Our restorative team states that DHI is a powerful tool but the real value comes from choosing it at the right moment for the right pattern.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  Many people searching who is a good candidate for a DHI hair transplant want a clear answer that is free from hype. DHI performs best when the goal is precision not maximum coverage. If your concern is creating a soft natural front line or filling controlled gaps DHI often fits the assignment perfectly.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    ...
                    <p className="text-black text-base md:text-lg font-medium">These situations benefit from the angle and depth precision of the Choi pen. The surgeon can implant each graft exactly where it should sit without disrupting existing hair.</p>
                  </div>

                  <div>
                    <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">When another method may be better and Suitability checks</h3>
                    ...
                    <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                      Our medical directors explain that DHI is not the default technique. It is the precise technique. We recommend it when it protects the donor and enhances detail not just because it sounds premium.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Why angle and direction matter and Useful zones</h3>
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">A natural hairline is not a straight line. It is a collection of micro angles. With a DHI hair transplant in Lahore each graft can be positioned individually creating soft transitions zigzag irregularity believable flow toward temples and clean directional blending. These micro details separate a natural result from an artificial look.</p>
                  ...
                  <div>
                    ...
                    <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                      Our senior physicians share that the Choi pen gives precision but precision must follow a plan. Without a balanced design technique alone means nothing.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 border-l-2 border-[#772424]/20 pl-4 sm:pl-6 ml-1 sm:ml-2 mb-6">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-1">Duration and Staging Timeline</h3>
                    ...
                    <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-5 rounded-2xl border-l-4 border-[#772424]">
                      Our supervising surgeons remind patients that a calm surgery day leads to better healing. Precision always works better when the environment is unhurried.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  ...
                  <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                    <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-2">What affects your tier quote and Global comparisons</h3>
                    <p className="text-black font-medium text-base leading-relaxed mb-3">Your custom tier quote depends on total grafts needed whether the case includes the hairline crown or both unshaven vs shaven approaches scattered thinning combined techniques donor density hair caliber surgeon time required and supportive additions like PRP.</p>
                    <p className="text-black font-bold text-base leading-relaxed border-t border-gray-200/80 pt-3">
                      Comparing investment ranges globally demonstrates an astonishing reality. DHI procedures in Pakistan sit inside local PKR package tiers offering incredible relative savings compared to upper tier calculations in the USA or UK while supplying elite cleanroom surgical standards.
                    </p>
                  </div>
                  ...
                  <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                    ...
                    <p className="text-black font-medium text-base leading-relaxed">
                      Comprehensive DHI care packages at Hair Skill bundle your complete cleanroom extractions Choi implanter placements post op medications first clinical wash and 12 months of scheduled follow up care upfront.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                  Our attending doctors state that DHI helps with comfort and detail but time is still the artist. Hair grows at its own pace.
                </p>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Expected side effects and Complications</h3>
                  ...
                  <div>
                    ...
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">No method can guarantee perfection. DHI gives surgeons precise control over angle and direction supporting natural results in detailed heavy zones. But donor strength scalp biology and design choices still determine your final appearance.</p>
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">In experienced cleanroom settings the DHI graft survival rate is exceptionally high often comparable to or slightly above classic FUE because grafts spend less time outside the body.</p>
                    <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                      Our surgical specialists explain that the method helps your result but the method never replaces judgment. Safe outcomes require discipline not just another tool.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    ...
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed">Natural does not mean overly dense up front. It means the hairline grows in irregular microangles. Density increases gradually toward the midscalp. Single grafts sit at the front; doubles and triples sit behind them. With a DHI hairline compared to an FUE hairline the difference often shows in softness allowing finer transitions and a less uniform look.</p>
                  </div>

                  <div>
                    <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Where DHI enhances aesthetics and Density reality</h3>
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">DHI excels at shaping detailed hairlines filling temple points blending with existing hair correcting past work correcting scattered part line thinning and edge directions. Some clinics promise extremely high density with DHI which is rarely safe. The role of DHI is controlled placement not pushing beyond biological constraints.</p>
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">Your before and after journey evolves slowly starting with early sprouts at months 3 to 4 major thickening at month 6 and ultimate refinement inside 12 to 18 months.</p>
                    <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                      Our medical directors summarize that a natural result is not a line. It is a language of angles. DHI gives us the vocabulary to shape that language.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-16">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  Planning your clinical staging in Lahore should feel completely calm and structured. Most patients allocate three to four days to complete their medical staging smoothly. Day one covers your clinical consultation microgeometry measurements and line mapping. Day two is the surgical extraction and Choi pen placement block. Day three covers your delicate first wash review and aftercare instruction under medical supervision.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                  Our senior physicians note that recovery is not about doing more. It is about giving your new grafts the calm they need.
                </p>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="pt-8 border-t border-gray-200 mb-16">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-4">
                  Our patients repeatedly say the care feels thoughtful the process stays organized and the result looks theirs naturally.
                </p>
