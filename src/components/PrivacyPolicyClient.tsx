            ...
            <div className={`w-full lg:w-2/3 flex flex-col gap-6 text-black text-base md:text-lg font-medium leading-relaxed`}>
              ...
              <div className={`border border-gray-200 p-8 rounded-2xl bg-gray-50/50 mb-6`}>
                ...
                <ul className={`space-y-1.5 text-sm md:text-base font-bold text-gray-700`}>
                  ...
                  <li>IX. HAIR SKILL CLINIC RESPONSE TO APPLICATIONS</li>
                ...
                <table className={`w-full text-left border-collapse`}>
                  ...
                  <tbody className={`divide-y divide-gray-100 text-sm md:text-base`}>
                    <tr>
                      ...
                      <td className={`p-4`}>Consent relating to a specific matter, given based on information and declared with free will for procedures like FUE hair transplant</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className={`p-4`}>Medical and administrative staff at Hair Skill Clinic</td>
                    </tr>
                    <tr>
                      <td className={`p-4 font-bold text-[#772424]`}>Employee Candidate</td>
                      <td className={`p-4`}>Natural persons who have applied for a job at Hair Skill Clinic by any means or who have made their resume available for Hair Skill Clinic review</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className={`p-4`}>An inventory created by data controllers by associating their personal data processing activities carried out in connection with their business processes</td>
                    </tr>
                    <tr>
                      <td className={`p-4 font-bold text-[#772424]`}>Anonymization of Personal Data</td>
                      <td className={`p-4`}>Anonymization of personal data means rendering personal data unable to be associated with an identified or identifiable natural person in any way</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className={`p-4`}>Data relating to health, genetic markers, medical treatments, and other highly sensitive information</td>
                    </tr>
                    <tr>
                      <td className={`p-4 font-bold text-[#772424]`}>Periodic Destruction</td>
                      <td className={`p-4`}>The process of automatically deleting personal data at recurring intervals specified in the data retention and destruction policy</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className={`p-4`}>Natural persons working in institutions with which Hair Skill Clinic has any business relationship.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td className={`p-4 font-bold text-[#772424]`}>Product or Service Recipient</td>
                      <td className={`p-4`}>Natural persons who use the products and hair restoration services offered by Hair Skill Clinic</td>
                    </tr>
                    <tr>
                      <td className={`p-4 font-bold text-[#772424]`}>Data Processor</td>
                      <td className={`p-4`}>A natural or legal person who processes personal data on behalf of the data controller</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className={`p-4`}>A natural or legal person who determines the purposes and means of processing personal data</td>
                    </tr>
                    <tr>
                      <td className={`p-4 font-bold text-[#772424]`}>Visitor</td>
                      <td className={`p-4`}>Natural persons who have entered Hair Skill Clinic physical premises for consultation or who visit our websites</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <p className={`mt-0`}>
                In processing your personal data, we act in accordance with laws, secondary regulations, and general principles of law; we prioritize processing personal data limited to the purpose of processing and taking into account the Data Subject reasonable expectations regarding their hair loss treatment.
              </p>
              ...
              <p className={`font-bold text-[#772424] mt-2 mb-0`}>Existence of the Data Subject Explicit Consent:</p>
              <p className={`w-full`}>
                The Data Subject personal data can only be processed if the Data Subject gives consent freely, with sufficient information about the personal data processing activity, without any doubt, and limited only to that specific transaction.
              </p>

              <p className={`font-bold text-[#772424] mt-2 mb-0`}>Clearly stipulated in laws:</p>
              <p className={`w-full`}>
                Personal data can be processed without the Data Subject Explicit Consent within the framework of the relevant legal regulation if it is explicitly stipulated in laws.
              </p>

              <p className={`font-bold text-[#772424] mt-2 mb-0`}>Inability to obtain the Data Subject Explicit Consent due to factual impossibility and the necessity of personal data processing:</p>
              <p className={`w-full`}>
              ...
              <p className={`w-full`}>
                Personal data that has been disclosed to the public in any way by the Data Subject and has become accessible to everyone as a result of this public disclosure can be processed without the Data Subject Explicit Consent, limited to the purpose of public disclosure.
              </p>
              ...
              <p className={`w-full`}>
                If data processing is mandatory for the establishment, exercise, or protection of a right, the Data Subject personal data may be processed.
              </p>
              ...
              <p className={`w-full`}>
                It can be processed with the Data Subject Explicit Consent or, if explicitly stipulated in laws, without the Data Subject Explicit Consent.
              </p>

              <p className={`font-bold text-[#772424] mt-2 mb-0`}>Personal data relating to health and sexual life:</p>
              <p className={`w-full`}>
                It can be processed with the Data Subject Explicit Consent or by persons or authorized institutions and organizations under an obligation of confidentiality, without the Data Subject Explicit Consent, for the purposes of protecting public health, preventive medicine, medical diagnosis, treatment and care services, planning and management of health services and their financing.
              </p>
              <p>
              ...
              <div className={`space-y-4 text-black text-sm md:text-base`}>
                <p><strong>Identity Information:</strong> Information contained in documents such as Driver License, Identity Card, Residence Permit, Passport, Marriage Certificate.</p>
                <p><strong>Contact Information:</strong> Telephone number, address, e-mail.</p>
                <p><strong>Personnel Information:</strong> Personal data processed to obtain information that will form the basis for the personnel rights of our medical staff, employees or natural persons in a working relationship with Hair Skill Clinic.</p>
                <p><strong>Legal Transaction Information:</strong> Personal data processed for the determination, follow-up of our legal receivables and rights, and the performance of our debts, as well as for our legal obligations and compliance with Hair Skill Clinic policies.</p>
                <p><strong>Customer Transaction Information:</strong> Records related to the use of our hair restoration services, medical treatments, and consultation history.</p>
                ...
                <p><strong>Professional Experience:</strong> Personal data processed for the purpose of measuring the performance of our employees or natural persons in a working relationship with our Company and planning and carrying out their career development within the scope of Hair Skill Clinic human resources policy.</p>
                <p><strong>Marketing Information:</strong> Personal data processed for the purpose of customizing and marketing our advanced hair transplant and medical tourism Pakistan services in line with the data subject usage habits, preferences, and needs, and reports and evaluations created as a result of this processing.</p>
                <p><strong>Visual and Audio Records:</strong> Photographs and camera recordings (such as before and after hair transplant pictures), audio recordings, and data contained in documents that are copies of documents containing personal data.</p>
              ...
              <p>
                Data transfer is carried out by <strong>Hair Skill Clinic</strong> for purposes such as ensuring the fulfillment of its operational and establishment objectives, securing the provision of services externally obtained from suppliers and necessary for Hair Skill Clinic commercial activities, ensuring the implementation of human resources and employment policies, fulfilling obligations within the framework of occupational health and safety and taking necessary measures, and providing necessary information to authorized public institutions and organizations.
              </p>
              <p>
              ...
              <ul className={`list-disc ml-6 space-y-1.5`}>
                <li>Special categories of personal data, other than those relating to health and sexual life, may be processed without the <strong>Explicit Consent</strong> of the Data Subject if explicitly provided for by law. Otherwise, the <strong>Explicit Consent</strong> of the Data Subject will be obtained.</li>
              ...
              <p>
                <strong>Hair Skill Clinic</strong>, in accordance with the PDPA and Article 32 of the GDPR, takes the necessary technical and administrative measures to ensure an appropriate level of security to prevent the unlawful processing of personal data and unlawful access to data, and to ensure the preservation of data. Within this scope, it conducts or has conducted the necessary audits, ensuring patient data security across our network, whether you visit us for a hair transplant in Karachi, Multan, or Lahore.
              </p>
              <p>
              ...
              <ul className={`list-disc ml-6 space-y-1`}>
                ...
                <li>Respecting the Data Subject rights regarding personal data, including the right of access.</li>
                ...
                <li>Retaining personal data only within the periods determined by legal regulations, Hair Skill Clinic legal obligations, or legitimate corporate interests, and as specified in Hair Skill Clinic Personal Data Retention and Destruction Policy.</li>
              ...
              <p>
                <strong>Hair Skill Clinic</strong> reserves the right to regularly and autonomously audit at any time, without prior notice, whether all its employees, departments, and suppliers comply with this Policy and PDPA & GDPR Regulations, and conducts or has conducted the necessary routine audits within this scope. The results of these audits are evaluated within the company internal operations, and necessary activities are carried out to improve the measures taken.
              </p>
              ...
              <ul className={`list-disc ml-6 space-y-1`}>
                <li><strong>Hair Skill Clinic</strong> identity,</li>
                ...
                <li>The Data Subject other rights listed in PDPA or GDPR.</li>
              </ul>
              <p>
                It must be ensured that this notification, in addition to the above, definitely includes the Data Subject rights listed in the PDPA, GDPR, and this Policy. The following points are taken into consideration when making the notification:
              </p>
              <ul className={`list-disc ml-6 space-y-1.5`}>
                ...
                <li>Notification can be made verbally, in writing, via sound recording through a call center, through various physical or electronic media, and by directing to a web page containing personal data notification texts and other media that may be announced later.</li>
              ...
              <ul className={`list-disc ml-6 space-y-1`}>
                ...
                <li>To request the deletion, destruction, or anonymization of personal data if the reasons for its processing have ceased to exist.</li>
                ...
                <li>To transfer personal data to a different data controller requested by the data subject.</li>
              </ul>
              <p>
              ...
              <h2 className={`text-2xl md:text-3xl font-black text-[#772424] uppercase tracking-tight mt-6`}>IX. HAIR SKILL CLINIC RESPONSE TO APPLICATIONS</h2>
              <p>
