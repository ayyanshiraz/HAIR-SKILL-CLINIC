            ...
            <div className="w-full lg:w-2/3 flex flex-col">
              ...
              <motion.div initial="hidden" animate="visible" variants={fadeUp} className="mb-12 flex flex-col gap-6">
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  Hair Treatment Mesotherapy in Pakistan is a targeted micro-injection method of non surgical hair restoration, placing vitamins, minerals, and growth-supporting compounds directly into the scalp. It focuses on slowing active shedding, improving density, and strengthening weakened follicles. Many patients choose this hair fall control treatment because it supports areas affected by androgenetic alopecia, early thinning, and seasonal shedding patterns.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  At Hair Skill Clinic, this treatment sits inside a wider medical strategy. You are not given random injections. You receive a plan built around your hair type, shedding pattern, and long-term goals. Every session aims to help you reach a stable, fuller look that feels natural to style. If you are searching for hair mesotherapy near me, our facility provides everything you need.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  The injections are placed into the mesoderm layer. This is where weak follicles respond best. By putting nutrients exactly where hair grows, mesotherapy for hair loss may improve scalp balance, hair texture, and strand strength. Studies suggest benefits for pattern hair loss when applied in structured protocols, often alongside PRP or medical therapy. It is not a standalone miracle, but it can still be a valuable step for the right patient.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  Hair loss feels overwhelming when you do not know what is causing it or how fast it will progress. Seeking mesotherapy hair treatment Pakistan at Hair Skill Clinic gives you a structured, doctor-led path to calmer shedding, stronger strands, and healthier roots. Every session is personalized, never generic. You know exactly what is being injected and why it fits your specific needs.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  While many clinics offer routine injections, Hair Skill treats hair mesotherapy as a targeted medical treatment built around diagnosis, scalp mapping, and clear goals. This difference shapes your results.
                </p>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-8">
                  <div>
                    ...
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed">Your plan is created by experienced physicians who specialize in androgenetic alopecia and hair restoration. There are no off-the-shelf formulas and no blind injections.</p>
                  </div>

                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Custom Blended Cocktails Tailored to Your Scalp</h3>
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed">Your treatment may include vitamin injections for hair growth, amino acids, minerals, and growth-supportive compounds. These are chosen to match the current state of your hair and your desired outcome.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed">Mesotherapy can stabilize shedding before a hair transplant, support native hair after surgery, or simply act as a hair loss solution without surgery to strengthen thinning areas.</p>
                  </div>

                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Real Patients See Real Progress</h3>
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">Less shedding, better texture, and a healthier shine. For many, these changes appear gradually yet noticeably over the treatment course.</p>
                  </div>
                </div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  This hair thinning treatment supports people facing early or moderate thinning, chronic shedding, and visible density loss. Many patients arrive unsure whether they qualify. They worry their hair is too far gone or not bad enough for a medical procedure. Mesotherapy fills the gap between simple topical products and full surgery. It gives the scalp direct support while keeping your options open for the future.
                </p>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-2">Hair Skill uses a blend of vitamins, minerals, amino acids, and growth-supportive compounds designed for thinning areas. These may include biotin, B-complex vitamins, and other ingredients used widely in mesotherapy treatments. Each component aims to improve scalp balance, follicle strength, and hair texture. Some patients benefit from formulas enriched with peptides or growth-supportive factors. These blends are selected based on your specific pattern, not a one-size-fits-all approach.</p>
                  </div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  ...
                  <div className="p-6 rounded-3xl bg-gray-50 border border-gray-200/80">
                    ...
                    <p className="text-black font-medium text-base leading-relaxed mb-3">Hair Skill often recommends a tailored plan depending on the graft growth stage. Some patients begin light mesotherapy a few months after surgery to support native hair and enhance texture across the scalp. It is never applied too early. Timing protects grafts and avoids irritation. After your initial sessions, you may choose maintenance treatments every 3 to 6 months. This keeps results steady, especially for patients with genetic thinning. Stopping maintenance may allow shedding to slowly return, which is a common pattern in androgenetic alopecia.</p>
                    <p className="text-black font-bold text-base leading-relaxed border-t border-gray-200/80 pt-3">
                      Our supervising doctors remind patients that the session count only works when the scalp is correctly diagnosed. Good planning saves time, money, and stress.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Mesotherapy vs PRP for Hair: What Patients Need to Know</h3>
                    <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">Mesotherapy vs prp for hair is a common debate. Mesotherapy delivers a blend of vitamins, minerals, amino acids, and supportive compounds into the scalp. It focuses on nourishing weakened follicles and improving scalp balance. PRP uses your own platelets. These platelets contain growth-supportive factors that may help boost follicle activity. Many patients feel PRP offers a stronger biological signal, while mesotherapy provides broader nutritional support.</p>
                  ...
                  <div>
                    ...
                    <div className="w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-100 relative mb-6 shadow-md">
                      <img src="/hair-transplant/30.webp" alt="Smiling patient giving thumbs up after successful restoration session" className="w-full h-full object-cover object-center" />
                    </div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Rare Risks, Safety Studies, and Technical Precision</h3>
                ...
                <div className="space-y-6 mb-6">
                  <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                    ...
                    <p className="text-black font-medium text-base leading-relaxed">
                      Pakistan has become a leading destination for non-surgical hair treatments because package tiers remain exceptionally accessible while medical standards stay high. Many clinics in Lahore offer sessions inside an affordable hair mesotherapy price band, structured around your full course of treatment. In Western hubs like the UK or US, granular per-session calculations make completing an eight-session protocol heavily capital-intensive. International visitors frequently discover they can secure a competitive mesotherapy hair treatment price in Lahore for a fraction of Western tier calculations.
                    </p>
                  </div>

                  <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                    <h3 className="text-xl font-black text-[#772424] mb-2">Hair Skill Clinic Package Brackets in PKR</h3>
                    <p className="text-black font-medium text-base leading-relaxed mb-3">Hair Skill keeps investment brackets completely straightforward. Your tier calculation behaves in accessible local PKR ranges, based on your compound formula and the overall mesotherapy session cost roadmap. Many patients choose a complete course of 4 to 8 sessions to stabilize shedding and bolster density upfront.</p>
                    <p className="text-black font-bold text-base leading-relaxed border-t border-gray-200/80 pt-3">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="pt-8 border-t border-gray-200">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  If your hair feels thinner each month, or your shedding has become a daily stress, you do not need to navigate this alone. Professional mesotherapy offers a structured, supportive way to protect your existing hair and improve density without committing to surgery right away. At the Hair Skill Clinic, every plan starts with listening. Your concerns, your goals, and your hair history shape everything that follows.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                ...
                <p className="text-black text-base md:text-lg font-medium mb-4">
                  If you want stronger strands, healthier roots, and better control over the future of your hair, your next step is simple: Send your photos. Share your questions. Tell us your goals upfront.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-extrabold">
                  A Hair Skill doctor reviews everything personally and responds with a realistic plan based on your stage of androgenetic alopecia and the potential of your hair. You deserve clarity. You deserve honesty. You deserve a team that treats your hair like it matters. Start your free assessment today.
                </p>
              </motion.div>
               {/* SECTION: 10 FAQS ACCORDION */}
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-16">
                <h2 className="text-3xl font-black text-[#772424] mb-8 tracking-tight border-b mt-8 pb-3 border-gray-100">
