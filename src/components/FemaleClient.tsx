  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .css-fade-up {
          animation: fadeUpAnim 0.8s cubic-bezier(0.2, 0.65, 0.3, 0.9) forwards;
        }
        .css-slide-right {
          ...
          <div className="max-w-[1300px] mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
              ...
              <div className="w-full lg:w-2/3 block">
                ...
                <div className="css-fade-up mb-12 flex flex-col gap-6">
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    Losing hair as a woman feels different. It is not just about coverage. It is about how you see yourself in photos, how confidently you style your hair, and how much you avoid mirrors on difficult days. That is why a female hair transplant journey in Pakistan needs a different approach than a standard male transplant.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    At Hair Skill Clinic, a female hair transplant in Pakistan is always based on diagnosis first and surgery second. Many women arrive believing a transplant is the only option or searching for a female hair transplant near me hoping for a quick fix. Sometimes it is. Sometimes medical treatment or a mix of both is the smarter path. Our job is to help you figure that out calmly step by step.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    In simple terms, a female hair transplant means taking permanent follicles from the stronger donor area at the back of the scalp and moving them to thinning zones such as the part line, temples, or frontal hairline. The goal is not just hair. The goal is a softer fuller frame that still looks like you.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    A female fue hair transplant or DHI procedure is carefully chosen where grafts from the permanent donor area are implanted into thinning areas like the part line, temples, or crown. It is highly suitable when hair transplant for female pattern baldness is needed and there is enough donor density in the back of the scalp.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    Hair Skill treats every female hair loss transplant case as a partnership. You bring your story, concerns, and goals. We bring honest assessment, careful design, and the best female hair transplant surgeon techniques adapted to female patterns instead of forcing you into a male style plan.
                  </p>
                </div>

                <div className="css-fade-up mb-14">
                  ...
                  <div className="space-y-6 mb-6">
                    <div>
                      ...
                      <div className="space-y-2 ml-2 mb-4">
                        {[
                          "those seeking hair transplant for female pattern baldness following Ludwig I or II",
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Who is not suitable</h3>
                      ...
                      <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-4">
                        Hair Skill will tell you honestly if surgery is not right now. You will not be pushed toward a female hair transplant you do not need or cannot benefit from.
                      </p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                        Our lead surgical specialists often remind patients. When the loss is stable and the donor is healthy, the female hair transplant results look incredibly natural. But identifying that stability must come first.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Pakistan has become one of the most trusted destinations for women seeking natural, subtle hair restoration. The country combines experienced surgeons, modern techniques, patient friendly pricing, and a warm, organized treatment experience. For many women, a female hair transplant in Pakistan journey offers the right balance of quality, comfort, and safety.
                  </p>

                  <div className="space-y-6 mb-6">
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Why Pakistan Is a Top Choice for Women</h3>
                      <p className="text-black text-base md:text-lg font-medium mb-3">Women from around the world travel to us each year for female hair restoration. Whether you want a female hair transplant in Lahore, a female hair transplant in Karachi, or are exploring our expanding reach for a female hair transplant in Islamabad, Rawalpindi, and Multan, the reasons are simple:</p>
                      <div className="space-y-2 ml-2 mb-4">
                        {[
                          "the best female hair transplant surgeon teams with high experience treating female patterns",
                          "clinics that understand unshaven and partial shave needs",
                          "refined techniques suited for delicate density work",
                          "affordable female hair transplant cost compared to the UK, USA, and Europe",
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Why Hair Skill Clinic Stands Out</h3>
                      ...
                      <div className="space-y-2 ml-2 mb-6">
                        {[
                          ...
                          "female fue hair transplant or DHI chosen based on your goals",
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">A Clinic That Listens</h3>
                      ...
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                        Our attending doctors often share. A woman's hairline and density story is personal. We tailor everything to protect softness, balance, and identity.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Hair loss in women almost always needs a closer look before deciding on surgery. A female hair loss transplant plan only makes sense when the cause of thinning is truly permanent. Many women experience shedding from hormones, stress, childbirth, thyroid shifts, nutrition gaps, or tight hairstyles. Those situations often improve with treatment rather than surgery. That is why diagnosis comes first at Hair Skill.
                  </p>

                  <div className="space-y-6 mb-6">
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Common patterns in women</h3>
                      ...
                      <p className="text-black text-base md:text-lg font-medium">Clinics use the Ludwig scale to describe severity from I to III, but real assessment depends on trichoscopy and donor analysis to predict the female hair transplant success rate.</p>
                    </div>

                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Causes worth investigating</h3>
                      ...
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed">Blood tests and scalp evaluation help separate temporary shedding from long term loss. This protects women from undergoing a female hair transplant too early, or when medical treatment would be more helpful.</p>
                    </div>

                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Why this step matters</h3>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <div className="w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-100 relative mb-8 shadow-md">
                    <Image width={1200} height={750} src="/hair-transplant/22.webp" alt="Macro close up view of delicate female part line follicular units K.C., 27 years old, 2400 grafts" className="w-full h-full object-cover object-center" />
                  </div>

                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Once diagnosis confirms stability, the next step is choosing the right method. A female hair transplant in Pakistan procedure is not a copy of a male surgery. Women often prefer to keep their existing hairstyle, avoid a full shave, and focus on restoring density rather than creating a dramatic new pattern. Hair Skill adapts the technique to those needs.
                  </p>

                  <div className="space-y-6 mb-6">
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">FUE for Women</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">A female fue hair transplant is a highly common approach. Individual follicles are extracted from the donor area at the back of the scalp usually through a partial shave hidden underneath long hair. This gives surgeons access while keeping the rest of the hairstyle intact.</p>
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">DHI for Women</h3>
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Unshaven or Partial Shave Options</h3>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <div className="space-y-6 mb-6">
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Clear expectations matter</h3>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    For many women, affordability is one of the biggest reasons to consider a female hair transplant in Pakistan journey. Pakistan offers advanced surgical quality inside accessible local package tiers. But price alone is not the value. What matters is surgeon involvement, design quality, and how naturally the result blends with your feminine hairline.
                  </p>

                  <div className="space-y-6 mb-6">
                    <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                      <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-2">Typical Cost Brackets in PKR</h3>
                      <p className="text-black font-medium text-base leading-relaxed">
                        Across trusted healthcare comparisons, the investment brackets in PKR comfortably cover most female fue hair transplant or DHI cases with specialized options for complex part line designs. Hair Skill Clinic typically offers accessible package brackets in local PKR tiers depending on graft count needed, the method chosen, and whether partial shave or unshaven methods are used. These local rates remain far below international premium calculations, making the female hair transplant cost highly competitive and structural restorations deeply value driven.
                      </p>
                    </div>

                    <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                      <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-2">Comprehensive Care Packages</h3>
                      <p className="text-black font-medium text-base leading-relaxed mb-3">Most international patients choose a comprehensive clinical package that includes the best female hair transplant surgeon consultation and personalized design procedure with partial shave techniques for discreet surgery, aftercare kit, and native concierge assistance during your clinical visits. No surprises. No confusion. Just a clear path forward.</p>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <div className="w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-100 relative mb-8 shadow-md">
                    <Image width={1200} height={750} src="/hair-transplant/23.webp" alt="Surgeon drawing delicate lowered feminine hairline contour on patient K.K., 37 years old" className="w-full h-full object-cover object-top" />
                  </div>

                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    A female hair transplant in Pakistan procedure at Hair Skill is designed to feel calm, predictable, and respectful of your existing hairstyle. Women often worry about shaving downtime or whether the result will look obvious. A clear step by step structure removes that anxiety and helps you envision exactly how the female hair transplant recovery unfolds.
                  </p>

                  <div className="space-y-6 border-l-2 border-[#772424]/20 pl-4 sm:pl-6 ml-1 sm:ml-2 mb-6">
                    <div>
                      <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-1">Step 1: Consultation and Diagnosis</h3>
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-1">Step 2: Donor Planning and Partial Shave</h3>
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-1">Step 3: FUE or DHI Extraction and Implantation</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed">The surgeon selects either a female fue hair transplant or DHI method depending on your goals. FUE allows efficient extraction for medium areas. DHI offers high precision for narrow zones like the part line. Grafts are placed with exact angulation so they blend with your natural direction and density.</p>
                    </div>
                    <div>
                      <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-1">Step 4: Female Hair Transplant Recovery Timeline</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed">Healing is smoother for women than many expect. What to anticipate. Day 1 to 3 mild swelling or tightness. Day 4 to 7 scabs begin softening. Day 5 to 7 many women return to work. Week 3 to 6 shedding phase. Month 3 to 4 early growth. Month 6 to 9 visible thickening. Month 12 to 14 full female hair transplant results.</p>
                    </div>
                    <div>
                      <h3 className="text-lg sm:text-xl font-black text-[#772424] mb-1">Step 5: Aftercare and Styling</h3>
                      ...
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-5 rounded-2xl border-l-4 border-[#772424]">
                        Our clinical specialists explain. For women, implantation must respect softness. The female hair transplant recovery is steady, and the transformation feels gradual but deeply rewarding.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <div className="space-y-6 mb-6">
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">The role of proper testing</h3>
                      <p className="text-black text-base md:text-lg font-medium mb-3">Before agreeing to a female hair loss transplant, Hair Skill checks for:</p>
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">When surgery and medical care work together</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">Women with early to moderate loss often experience the best improvement when a transplant addresses structural gaps and medical therapy protects remaining hair. This combination reduces the risk of needing larger procedures later.</p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Female hair loss rarely feels like just a cosmetic issue. It affects daily emotions, social comfort, and the small moments most people take for granted. When the part line widens or photos start to feel uncomfortable, confidence shifts quietly but deeply. A female hair transplant in Pakistan journey is often about far more than adding density. It is about reclaiming easy identity and self expression.
                  </p>

                  <div className="space-y-6 mb-6">
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">How thinning affects women differently</h3>
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Restoring confidence through design</h3>
                      <p className="text-black text-base md:text-lg font-medium mb-3">A female hair transplant focuses on restoring harmony, not changing appearance. Small thoughtful improvements often create the biggest emotional shift:</p>
                      <div className="space-y-2 ml-2 mb-4">
                        {[
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-8">
                    Female hair restoration is not limited to treating scalp thinning. Many women combine a female hair transplant in Pakistan plan with related enhancements to refine facial framing. These adjustments are subtle but powerful, helping restore softness and balance where it matters most.
                  </p>

                  <div className="w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-100 relative mb-8 shadow-md">
                    <Image width={1200} height={750} src="/hair-transplant/24.webp" alt="Surgeon placing delicate single hair grafts into female brow S.F.H., 33 years old, 650 grafts" className="w-full h-full object-cover object-center" />
                  </div>

                  <div className="space-y-6 mb-6">
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Eyebrow Transplant for Women</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">Eyebrows shape expressions and define the upper face. Loss from overplucking age or medical conditions can make the eyes look tired or less expressive.</p>
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Hairline Lowering and Feminine Hairline Design</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">Some women feel their forehead looks larger than they prefer. Others just want more feminine curvature. Transplant-based lowering is an effective option when the native hairline sits higher than ideal.</p>
                      ...
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed">For women considering surgical hairline lowering, a transplant can sometimes be a gentler alternative. Thinning around the temples affects how the face is framed. A small number of carefully angled grafts can dramatically improve symmetry and softness.</p>
                    </div>

                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Combined Procedures for Natural Harmony</h3>
                      <p className="text-black text-base md:text-lg font-medium mb-3">Many women ask about pairs of treatments such as a female hair transplant plus eyebrow transplant, part line density plus temple strengthening, or hairline refinement plus PRP. These combos work well because they holistically enhance facial framing.</p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Understanding what results look like at every stage helps women feel calm, prepared, and confident about their female hair transplant in Pakistan journey. If you search for female hair transplant near me, you will find that at Hair Skill the goal is not dramatic change. It is natural harmony. The best outcomes blend with your features so well that no one can pinpoint what changed. They just notice you look refreshed.
                  </p>

                  <div className="space-y-6 mb-6">
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">What realistic results look like</h3>
                      <p className="text-black text-base md:text-lg font-medium mb-3">Female hair transplant before and after photos often show:</p>
                      <div className="space-y-2 ml-2 mb-4">
                        {[
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Timeline of visible changes</h3>
                      ...
                      <p className="text-black text-base md:text-lg font-medium">This gradual timeline is why female hair transplant before and after photos at 6 and 12 months matter more than immediately after surgery.</p>
                    </div>

                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-3">Styling freedom after surgery & Final outcome factors</h3>
                      <p className="text-black text-base md:text-lg font-medium mb-3">Once new hair grows, women enjoy easier daily styling, less reliance on powders or volumizers, comfort in wind, bright light, or cameras, and more hairstyles without worrying about exposing thinning spots. Excellent female hair transplant results depend on donor density, pattern stability, chosen technique, and commitment to aftercare. Medical support for hormones, ferritin, and general scalp health also reinforces long term success.</p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                ...
                <div className="css-fade-up mb-16">
                  <h2 className="text-2xl sm:text-3xl font-black text-[#772424] mb-6 tracking-tight border-b pb-3 border-gray-100">
                    Planning Your Female Hair Transplant Staging in Lahore Pakistan
                  </h2>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Preparing for your female hair restoration staging in Lahore should feel completely simple and unhurried. Most women prefer a short, highly organized clinical sequence that fits comfortably into their everyday routines. Our clinical coordination team manages your scheduling touchpoints smoothly, whether you travel for a female hair transplant in Lahore, a female hair transplant in Karachi, or from our upcoming setups providing a female hair transplant in Islamabad, Rawalpindi, and Multan.
                  </p>

                  <div className="space-y-6">
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Clinical Staging Sequence & Outings</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">Most patients allocate three to four days for their complete clinical staging sequence: Day 1 personal clinical consultation, trichoscopy audit, diagnostic blood tests, and line mapping. Day 2 the gentle extraction and implantation session. Day 3 official first clinical wash review and aftercare dressing instruction. Day 4 optional final check before returning to your regular schedule.</p>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">Keep clothes simple and comfortable. Bring loose button front shirts that do not pull over the head, a soft neck pillow for sleeping elevated, and gentle localized shampoo. Strictly avoid high restrictive collars, tight headbands, or heavy hats that press against the recipient area.</p>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">If you feel up to gentle walking once localized swelling settles, Lahore's calm, patient friendly districts offer lovely quiet park spaces and peaceful cafes. Simply avoid direct harsh sunlight, physical exertion, heavy crowds, and anything that risks friction against your newly placed grafts.</p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                    ...
                    {faqList.map((faq, idx) => {
                      ...
                      return (
                        <div key={idx} className={`border border-gray-200 transition-all duration-300 ${isOpen ? "rounded-3xl bg-gray-50 shadow-md" : "rounded-2xl bg-white"}`}>
                          ...
                          {isOpen && (
                            <div className="px-4 sm:px-6 pb-6 animate-[fadeIn_0.3s_ease-in-out]">
                ...
                <div className="css-fade-up pt-8 border-t border-gray-200">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-4">Why Women Trust Hair Skill Clinic</h3>
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Treatment Packages Designed for International Patients</h3>
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-2">Your Next Step Starts Here</h3>
              ...
              <div className="w-full lg:w-1/3 lg:sticky lg:top-32 h-fit css-slide-right">
                <div className="bg-[#772424] text-white rounded-3xl p-6 sm:p-8 shadow-2xl relative w-full border border-[#8c2a2a]">
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="flex items-start sm:items-center gap-2 mt-2">
                      <input type="checkbox" id="fmlPrivacy" required defaultChecked className="w-4 h-4 mt-0.5 sm:mt-0 accent-[#C5A059] rounded cursor-pointer shrink-0" />
                      <label htmlFor="fmlPrivacy" className="text-xs text-white/80 cursor-pointer leading-relaxed">
