...
export default function BlogClient() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const textMessage = `Hello! I would like to get a free consultation from the Blog Page.\n\n*Name*: ${fullName}\n*Email*: ${email}\n*Phone*: ${selectedCountry.dial} ${phone}`;
  ...
  // --- STRICTLY TWO BLOG ARTICLES (Verbatim from reference screenshot) ---
  const blogPosts: BlogPost[] = [
    {
      title: "Can Patients with Seborrheic Dermatitis Undergo Hair Transplantation?",
      image: "/blog/dermatitis.jpg",
      ...
      >
        <div className="max-w-[1300px] mx-auto relative">
          ...
          <div className="text-xs font-black uppercase tracking-widest text-black mb-3 flex items-center gap-2 justify-start">
            ...
            <span>/</span>
            <span className="text-[#772424]">Blogs</span>
          </div>
          
          {/* Title locked dead center independently */}
              ...
              <div className="bg-[#772424] text-white rounded-3xl p-8 shadow-2xl relative w-full border border-[#8c2a2a]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <input type="checkbox" id="blogPrivacy" required defaultChecked className="w-4 h-4 accent-[#C5A059] rounded cursor-pointer" />
                    <label htmlFor="blogPrivacy" className="text-xs text-white/80 cursor-pointer">
