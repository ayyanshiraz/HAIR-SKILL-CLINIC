...
export default function HairTransplantClient() {
  ...
  const transplantArticles: TransplantArticle[] = [
    ...
    },
    {
      ...
      image: "/transplant/widows-peak.jpg",
    ...
    {
      title: "Hair Transplant Pakistan Cost",
      image: "/transplant/cost-banner.jpg",
      summary: "The hair transplant Pakistan cost typically ranges from affordable standard packages to comprehensive VIP options depending on the surgical method you choose.",
      link: "/price"
    },
    
    {
      title: "Best Hair Doctor Pakistan Top Surgeons for Hair Transplant in Lahore 2026",
      image: "/transplant/top-surgeons.jpg",
    ...
    },
    {
      ...
      image: "/transplant/side-effects.jpg",
    ...
    },
    {
      ...
      image: "/transplant/acell-emp.jpg",
    ...
    },
    {
      ...
      image: "/transplant/unshaven-secret.jpg",
    ...
    },
    {
      ...
      image: "/transplant/afro-hair.jpg",
    ...
    },
    {
      ...
      image: "/transplant/sideburns.jpg",
    ...
    },
    {
      ...
      image: "/transplant/moustache.jpg",
    ...
    },
    {
      ...
      image: "/transplant/female-transplant.jpg",
    ...
    },
    {
      ...
      image: "/transplant/needle-free.jpg",
    ...
    },
    {
      ...
      image: "/transplant/mesotherapy-care.jpg",
    ...
    },
    {
      ...
      image: "/transplant/body-hair.jpg",
    ...
    },
    {
      ...
      image: "/transplant/manuel-fue.jpg",
    ...
    },
    {
      ...
      image: "/transplant/sapphire-blade.jpg",
    ...
    },
    {
      ...
      image: "/transplant/female-hair-loss.jpg",
                ...
                >
                  <Link href={art.link} className="flex flex-col flex-1 h-full block cursor-pointer">
                    ...
                    <div className="p-8 flex flex-col flex-1 justify-between bg-white">
                      <div>
                        <h2 className="text-xl font-extrabold text-[#772424] mb-3 leading-snug group-hover:translate-x-0.5 transition-transform">
                          {art.title}
                        </h2>
              ...
              <div className="bg-[#772424] text-white rounded-3xl p-8 shadow-2xl relative w-full border border-[#8c2a2a]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <input type="checkbox" id="mainTransplantPrivacy" required defaultChecked className="w-4 h-4 accent-[#C5A059] rounded cursor-pointer" />
                    <label htmlFor="mainTransplantPrivacy" className="text-xs text-white/80 cursor-pointer">
