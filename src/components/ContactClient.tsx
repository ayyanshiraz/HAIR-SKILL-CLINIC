  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-black font-sans selection:bg-[#772424] selection:text-white pb-24">
        ...
        <section className="pt-28 lg:pt-36 pb-12 bg-gray-50 border-b border-gray-200 px-6 css-fade-up">
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="w-full lg:w-2/3 flex flex-col gap-12">
                ...
                <div className="w-full h-[350px] md:h-[450px] rounded-3xl overflow-hidden shadow-lg border border-gray-100 relative bg-gray-100 group cursor-pointer css-fade-up">
                  <a 
                ...
                <div className="flex flex-col gap-8 css-fade-up">
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                      <h2 className="text-xl font-black text-[#772424] tracking-tight uppercase">HEADQUARTERS (LAHORE):</h2>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                      <h2 className="text-xl font-black text-[#772424] tracking-tight uppercase">KARACHI OFFICE:</h2>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed">
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                      <h2 className="text-xl font-black text-[#772424] tracking-tight uppercase">EMAIL:</h2>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                      <h2 className="text-xl font-black text-[#772424] tracking-tight uppercase">WHATSAPP:</h2>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                      <h2 className="text-xl font-black text-[#772424] tracking-tight uppercase">PHONE:</h2>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                      <h2 className="text-xl font-black text-[#772424] tracking-tight uppercase">TIMINGS:</h2>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed">
                        10am - 8pm
                      </p>
                    </div>
