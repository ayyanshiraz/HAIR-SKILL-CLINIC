...
export default function AboutPageClient() {
  ...
  const aboutArticles = [
    ...
    },
    {
      ...
      image: "/about/2.webp",
      summary: "At Hair Skill Clinic, our mission is to provide our patients with reliable, innovative, and high-quality hair transplant solutions. Our vision is to become the worlds leading hair transplant clinic.",
      link: "/about/mission"
    },
    {
    ...
    },
    {
      ...
      image: "/about/5.webp", 
      summary: "Personal Data Protection Policy. The principles of Hair Skill Clinic for the protection and processing of personal data are defined in this policy.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.div variants={fadeUp} className="grid grid-cols-2 gap-6 pt-6 border-t border-gray-200">
                ...
                <div>
                  <h4 className="text-4xl md:text-5xl font-black text-gray-900 mb-2 flex items-center">
                    <AnimatedStat to={5} duration={2.5} />
                    <span className="text-[#772424]">k+</span>
                  </h4>
                  <p className="text-xs md:text-sm text-gray-500 font-bold uppercase tracking-wider">Clientage</p>
                </div>
              </motion.div>
            </motion.div>
