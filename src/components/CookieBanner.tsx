    ...
    <AnimatePresence>
      {showBanner && (
        ...
        >
          ...
          */}
          <div className="w-full max-w-[95%] 2xl:max-w-7xl mx-auto pointer-events-auto bg-[#772424] border border-gray-800 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] rounded-2xl px-5 py-3.5 md:px-6 md:py-4 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto shrink-0">
              <button
                ...
                className="px-6 py-2 text-sm font-bold text-gray-900 uppercase tracking-wider border border-gray-800 rounded hover:bg-gray-900 hover:text-white transition-colors w-full sm:w-auto text-center"
              >
