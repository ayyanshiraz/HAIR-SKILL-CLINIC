            ...
            <div className="w-full lg:w-2/3 block">
              ...
              <motion.div initial="hidden" animate="visible" variants={fadeUp} className="mb-12 flex flex-col gap-6">
                ...
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  FUE Motorized Hair Transplant is a modern hair restoration technique that uses a specialized motorized punch device to extract hair follicles from the donor area. This method allows efficient graft harvesting while maintaining excellent graft quality and natural-looking results.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  Motorized FUE is a popular option for patients requiring a larger number of grafts and offers a minimally invasive approach to hair transplantation.
                </p>
              </motion.div>

              {/* BENEFITS SECTION */}
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-12">
                <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-4">Benefits of FUE Motorized</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                <h3 className="text-xl sm:text-2xl font-black text-[#772424] mb-4">Recovery & Aftercare</h3>
                <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424] flex flex-col gap-4">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    Our specialists will assess your condition and provide personalized guidance throughout your recovery journey.
                  </p>
                </div>
              </motion.div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14 flex flex-col gap-6 pt-6 border-t border-gray-200">
                <h2 className="text-2xl sm:text-3xl font-black text-[#772424] tracking-tight">
                  Advanced Technology at Hair Skill Clinic
                </h2>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  By utilizing calibrated micro-punches attached to a low-rotation electric handpiece, our surgeons can rapidly isolate follicular groupings without generating excessive heat or friction. This protects the surrounding tissue and significantly shortens the time your grafts spend outside the scalp.
                </p>
                <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                  Whether you are looking to restore a receding frontal line or achieve complete crown coverage, motorized harvesting offers the speed and safety necessary for high-volume megasessions while keeping patient fatigue to an absolute minimum.
                </p>
              </motion.div>
