  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-black font-sans selection:bg-[#772424] selection:text-white pb-24">
        ...
        <section className="pt-28 lg:pt-36 pb-12 bg-white px-6 css-fade-up">
          <div className="max-w-[1300px] mx-auto relative">
            <div className="text-xs font-black uppercase tracking-widest text-black mb-3 flex flex-wrap items-center gap-2 justify-start">
              ...
              <span className="whitespace-nowrap">/</span>
              <span className="text-[#772424] whitespace-nowrap">Beard Transplant</span>
            </div>
        ...
        <section className="py-12 px-6 bg-white">
          <div className="max-w-[1300px] mx-auto">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="w-full lg:w-2/3 flex flex-col">
                ...
                <div className="css-fade-up mb-12 flex flex-col gap-6">
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    If you are searching for a beard transplant in Pakistan, a guide that feels honest, calm, and grounded in real treatment experience, you are in the right place. Many readers arrive here because they feel stuck with a patchy beard, facial gaps, or old scars that never grow hair. Others simply want a fuller, sharper, more defined beard shape but feel overwhelmed by mixed information online. This page helps you understand what a beard transplant really involves, what Hair Skill Clinic does differently, and how to plan your restoration smoothly.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    Pakistan hosts thousands of facial hair restoration patients each year. Lahore, especially, has become a clinical hub for beard transplants in Lahore thanks to experienced surgeons and highly accessible package tiers. At the Hair Skill Clinic, our doctors rely on natural design logic, gentle extraction techniques, and our core institutional philosophy that guides every procedure. Whether you need small areas repaired or a full beard hair transplant, our approach focuses on long-term health and authentic density.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    Most visitors ask the same early questions. How does a beard hair transplant in Pakistan work? How many grafts do I need? What is the recovery time? And of course, central calculus. What is the average beard transplant cost in Pakistan? These answers shape your expectations before you even step into our cleanroom facility.
                  </p>

                  <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424] my-2 ml-2">
                    <h2 className="text-xl font-black text-[#772424] mb-2">To give you fast clarity, here is what most patients want to know first</h2>
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    At Hair Skill, we lead you through every step quietly and simply without pushing graft numbers or unrealistic promises. Our lead surgical specialists note that first-time patients often underestimate the importance of direction and curl alignment. Beard work is microgeometry. Density means nothing if the angles are wrong.
                  </p>

                  <h2 className="text-3xl font-black text-[#772424] mt-4 tracking-tight">
                    Beard Hair Transplant at Hair Skill Clinic
                  </h2>
                  <h3 className="text-xl font-extrabold text-[#772424]">
                    A Natural Beard. Designed With Precision. Built With Care.
                  </h3>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium">
                    If your beard has never grown the way you hoped or you are tired of hiding patchy areas, Hair Skill Clinic offers a calm, doctor-led solution that finally delivers lasting facial hair. Real surgeons, not sales scripts, guide every step. Your new beard transplant is shaped according to your features with soft transitions, balanced angles, and long-term harmony.
                  </p>
                ...
                <div className="css-fade-up w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-100 relative mb-8 shadow-md">
                  <Image width={1200} height={750} src="/hair-transplant/treatments/3.webp" alt="Patient J.V., 24 years old, mapped with black pen marker for 4560 graft lower face procedure" className="w-full h-full object-cover object-top" />
                </div>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                    At the Hair Skill Clinic, we match this national experience with a calm, structured medical environment. Our senior physicians often say that regional reputation works only when each clinic protects it. Skill improves with repetition, but honesty is what keeps patients safe.
                  </p>
                </div>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    People seeking a beard transplant in Karachi or Lahore usually want two things. Natural density and a clinic where the doctors are genuinely involved. This is where the Hair Skill Clinic excels. Instead of prioritizing graft counts or rushed sessions, our team focuses on design logic, safe donor use, and harmony with your facial structure. Every procedure follows our core institutional philosophy, a treatment approach built on precision and empathy.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Hair Skill is not a generic clinic where assistants do the core work. Your evaluation, beard mapping, and design are executed directly by our reconstructive surgeons who lead the medical team. Their backgrounds span reconstructive work, microsurgery, and high-volume international cases, which helps them spot the tiny details that separate a natural beard from a stiff one.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Many readers tell us they compare hair skills with many places, local or overseas options. These clinics may offer competitive pricing or striking beard transplant before-and-after photos. Hair skill differences are subtler. You feel it in the calm preoperative conversation. You see it in the donor management plan that protects your long-term appearance. You notice it when the doctor adjusts a beard line by two millimeters because that measurement changes balance and masculinity.
                  </p>
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-4">
                    Patients looking for reliable reviews often point to Hair Skills steady, predictable outcomes. Our clinical team puts it simply. A beard should feel like it grew there naturally. If someone can point out the beard transplant, we missed something.
                  </p>
                  ...
                  <div className="space-y-2 ml-2">
                    {[
                      ...
                      "Freedom from patchy scars and uneven density",
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <div className="space-y-6 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                        Our surgical leadership reminds patients that technique is only one part of the outcome. Most failed cases happen not because of the method but because angles were wrong or the density plan was rushed during the beard hair transplant.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Understanding the entire journey helps calm most worries. Many people search for procedures step by step day by day or ask how long each phase takes. At the Hair Skill Clinic, experience follows a clear roadmap. You always know what will happen next, how long it will take, and what you should feel during each stage. Below is a simple walkthrough of how a beard transplant in Lahore unfolds at Hair Skill.
                  </p>
                  ...
                  <div className="space-y-6 border-l-2 border-[#772424]/20 pl-6 ml-2 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">Before leaving, you receive a simple aftercare kit and step-by-step guidance on when to wash, how to sleep, and when you can shave safely.</p>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Most people want a clear picture of healing before committing to facial surgery. Questions about healing stages, returning to work, and safe shaving show up in almost every conversation. The good news is that beard healing follows a predictable rhythm. Once you understand the phases, the entire journey feels lighter and less intimidating. Here is the full timeline as we teach it at the Hair Skill Clinic.
                  </p>
                  ...
                  <div className="space-y-6 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">Months 3 to 5: New hair starts pushing through, thin and soft and sometimes curly in unexpected ways. Do not judge the result yet. You can resume beard oils or light grooming upfront as confidence returns. Months 6 to 9: Your beard looks stronger, and direction becomes more stable upfront. You start receiving compliments because improvement feels natural rather than sudden. Many patients begin comparing their progress with beard transplant before-and-after photos.</p>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">Month 12 and Beyond: By months 11 and 12, your beard has matured. Angles settle, density evens out, and everything blends with natural hair, completing the 12-month timeline. Hair Skill monitors each stage closely to avoid unnecessary worry.</p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    People often search for beard transplant cost calculations before looking at medical details. Price matters. But price only makes sense when you understand what you are paying for upfront. At the Hair Skill Clinic, transparency is part of the process. You get a clear package bracket in local PKR tiers upfront without sales pressure.
                  </p>
                  ...
                  <div className="space-y-6 mb-6">
                    <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                      ...
                      <p className="text-black font-medium text-base leading-relaxed">
                        Across accredited facilities in Lahore, partial beard or mustache restorations sit inside accessible introductory brackets in PKR, which often beats the average beard transplant cost in Karachi, while complete full-face transformations move into comprehensive upper-tier package ranges upfront. Fixed packages in Lahore offer massive relative savings over Western per-graft fee structures. Cheap unaccredited options usually cut corners on medical hygiene, paying the price later. Whether you need to know the beard hair transplant cost or general pricing, we keep it clear.
                      </p>
                    </div>

                    <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                      <h3 className="text-xl font-black text-[#772424] mb-2">Hair Skill Clinic Package Inclusions</h3>
                      <p className="text-black font-medium text-base leading-relaxed mb-3">Hair Skill provides balanced package brackets reflecting surgeon involvement, technique selection, and detailed aftercare. Your custom tier quote depends on beard size, target density, the method chosen (Sapphire FUE or DHI), additional touch areas like sideburns, and your donor capacity. Packages commonly bundle cleanroom extraction, microchannel incisions, cellular aftercare medications, translator assistance, and 12 months of scheduled review monitoring upfront. High-volume, low-cost centers rely on non-medical staff. Premium clinics offer genuine doctor supervision, which justifies the beard transplant cost in Pakistan.</p>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Anyone researching facial restoration eventually worries about safety. News stories about clinical malpractice infections or overharvesting make people nervous long before seeking normal healing. These concerns are valid. Facial surgery requires precision, hygiene, and stable medical oversight. When shortcuts happen, problems follow. Hair Skill Clinic approaches safety with a structured doctor-led workflow. Every stage has checks to protect grafts, preserve donor health, and avoid long-term issues. Beard surgery may look simple online, but the face is one of the most visible areas of your identity. That is why safety is central to every step here.
                  </p>
                  ...
                  <div className="space-y-6 mb-6">
                    <div>
                      ...
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed">Potential complications seen in low-quality centers include infection at incorrect angles, overharvested donor zones, uneven growth in ingrown hairs, and visible scarring in the mustache or chin. Many clinics highlight these risks when warning patients about unlicensed operators. The pattern is always the same. When technicians replace surgeons, outcomes suffer.</p>
                    </div>

                    <div>
                      <h3 className="text-2xl font-black text-[#772424] mb-2">Safety Protocols & Avoiding Low-Quality Trap Clinics</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">Hair Skill focuses on controlled, predictable steps, including surgeon-led design of sterile operating rooms; graft handling standards that preserve vitality; measured density planning to prevent shock loss; donor protection techniques maintaining even extraction; and one-year follow-up monitoring. We also screen for active dermatitis or untreated infections.</p>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">We avoid low-quality trap clinics that advertise unrealistic numbers with zero medical detail. These centers rely on non-medical staff and aggressive extraction. We keep standards higher because the beard is permanent upfront. We want your face to look natural at 30, 40, and 60.</p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    A beard transplant is not only about covering empty areas. It is about shaping identity. Many readers search for line designs, full transformations, cheek-filling goatee placements, or mustache tapers because they want a style fitting their face, personality, and lifestyle. At the Hair Skill Clinic, design comes first; density comes second. We do not apply one template to every patient. Your beard shape is built according to bone structure, age, and natural growth pattern. Below are common requests and how our surgeons approach them.
                  </p>

                  <div className="space-y-6 mb-6">
                    <div>
                      <h3 className="text-2xl font-black text-[#772424] mb-2">Full Beard Transformation & Cheek Filling</h3>
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-3">A full beard transplant covers cheeks, jawline, chin, and mustache, ideal for men with widespread patchiness or minimal natural growth. The challenge here is maintaining harmony between all facial zones. Density needs to increase gradually from cheek to jawline to avoid a heavy block of color, using sapphire FUE for soft, blended transitions.</p>
                    ...
                    <div>
                      ...
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">A goatee transplant helps when central areas lack density, adding structure around the mouth. Moustache requests slow, detailed angle adjustments across millimeters via DHI implanter pens. Sideburn to beard connections shape facial flow, determining final authenticity. Even single hair adjustments matter.</p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Many readers wonder whether they can get a scalp and beard hair transplant in Pakistan at the same time, especially when traveling to Lahore or Karachi. The short answer is yes. Combined sessions are possible when donor density is strong, and the design plan is realistic. At the Hair Skill Clinic, we treat combination procedures with extra care because donor management becomes more sensitive. A single bad decision can affect both your scalp and facial aesthetics for years.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  ...
                  <div className="space-y-6 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                        Our supervising doctors emphasize this. Your donor zone is a lifelong asset. Combination surgery only works when the plan respects biology, not just desire.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="css-fade-up mb-14">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Anyone comparing clinics online eventually searches for beard transplant before-and-after photos to imagine their future self. At the Hair Skill Clinic, before and after photos are used carefully. We show realistic improvements, not heavily filtered images or shaved angles that hide patchiness. Our goal is to show real faces, real lighting, and real density progression over time.
                  </p>
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                  ...
                  <div className="space-y-6 mb-6">
                    <div>
                      ...
                      <p className="text-black text-base md:text-lg font-medium leading-relaxed mb-4">For repairs to old trauma, acne traces, or failed surgeries, use targeted grafting with single hair units to conceal traces of injury. Your beard reaches peak maturity around month 12, continuing to thicken through month 15.</p>
                      <p className="text-black text-base md:text-lg leading-relaxed font-bold bg-gray-50 p-6 rounded-2xl border-l-4 border-[#772424]">
                ...
                <div className="css-fade-up mb-16">
                  ...
                  <p className="text-black text-base md:text-lg leading-relaxed font-medium mb-6">
                    Most international patients seek comprehensive care packages long before scheduling their visit. Traveling for clinical staging is completely smooth when logistical touchpoints are managed quietly. Lahore receives thousands of medical travelers familiar with facial restorations, so our cleanroom facility manages your scheduling seamlessly for your beard transplant in Lahore.
                  </p>
              ...
              <div className="w-full lg:w-1/3 lg:sticky lg:top-32 css-slide-right">
