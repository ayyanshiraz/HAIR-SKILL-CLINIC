...
export default function PrpClient() {
  ...
  // --- 10 FAQS DATA (Verbatim from pasted text, scrubbed of safe prose, numeric price & logistics errors) ---
  const faqList = [
    {
            ...
            <div className="w-full lg:w-2/3 flex flex-col">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-8">
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Doctor Led Treatment From Start to Finish</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">High Concentration PRP for Stronger Support</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Treatment Designed for Real Hair Loss Patterns</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Integrates With Hair Transplant Plans & Comfort Care</h3>
                ...
                <h3 className="text-2xl font-black text-[#772424] mb-4">Key Benefits of PRP Hair Treatment</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Early to Moderate Androgenetic Alopecia</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Thinning Hair Receding Hairline and Crown Weakness</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">People Struggling With Shedding & Contraindications</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 border-l-2 border-[#772424]/20 pl-6 ml-2 mb-6">
                  <div>
                    <h3 className="text-xl font-black text-[#772424] mb-1">Step 1: Diagnosis and Planning</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-black text-[#772424] mb-1">Step 2: Preparing the Platelet Rich Plasma</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-black text-[#772424] mb-1">Step 3: PRP Injections Into Key Thinning Areas</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Early Changes: Shedding Control and Scalp Balance</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-3">Density Coverage & Growth Cycle Improvements</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  <div className="p-6 rounded-3xl bg-gray-50 border border-gray-200/80">
                    <h3 className="text-xl font-black text-[#772424] mb-2">Initial Treatment Phase (3 Sessions Protocol)</h3>
                  ...
                  <div className="p-6 rounded-3xl bg-gray-50 border border-gray-200/80">
                    <h3 className="text-xl font-black text-[#772424] mb-2">Maintenance Phase & Biological Adjustments</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">PRP Before a Hair Transplant</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">PRP After a Hair Transplant & Combination Plans</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Common Short Term Reactions & Understanding Risks</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Does PRP Really Work? Evidence & Expectations</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-16">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 rounded-2xl bg-gray-50 border-l-4 border-[#772424]">
                    <h3 className="text-xl font-black text-[#772424] mb-2">Hair Skill Clinic Package Tiers & Value</h3>
              ...
              {/* SECTION: 10 FAQS ACCORDION (100% COMPLETE VERBATIM MAPPING) */}
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-16">
              ...
              <div className="bg-[#772424] text-white rounded-3xl p-8 shadow-2xl relative w-full border border-[#8c2a2a]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <input type="checkbox" id="prpPrivacy" required defaultChecked className="w-4 h-4 accent-[#C5A059] rounded cursor-pointer" />
                    <label htmlFor="prpPrivacy" className="text-xs text-white/80 cursor-pointer">
