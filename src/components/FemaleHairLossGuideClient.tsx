        ...
        <div className="max-w-[1300px] mx-auto">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="w-full lg:w-2/3 flex flex-col">
              ...
              {/* IMAGE 1: Flagship Hero Visual (Capture image_1ae5d2.jpg: Woman looking in mirror with marked hairline) */}
              <motion.div initial="hidden" animate="visible" variants={fadeUp} className="w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-900 relative mb-10 shadow-xl group">
                <img 
                  src="/blog/female-hair-loss-hero.jpg" 
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Alopecia Androgenetica (AGA)</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Changes in Hormones & Traction Type Alopecia</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Iron deficiency anaemia & Adverse effects of medication</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Emotional trauma stress & Inadequate Nutrition</h3>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                {/* IMAGE 2: Ludwig Scale Staging Graphic (Capture image_1ae5da.jpg: Staging scale graphic) */}
                <div className="w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-50 border border-gray-200/80 relative mb-8 shadow-md">
                  <img src="/blog/ludwig-scale-staging.jpg" alt="Clinical Ludwig Scale classification graphic illustrating Stage 1, Stage 2, and Stage 3 female pattern hair loss" className="w-full h-full object-contain p-4" />
                </div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                {/* IMAGE 3: Distressed Woman Showcase (Capture image_1ae613.jpg: Woman holding head) */}
                <div className="w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-100 relative mb-8 shadow-md">
                  <img src="/blog/distressed-woman-showcase.jpg" alt="Distressed female patient holding head demonstrating the psychological impact of unaddressed hair shedding" className="w-full h-full object-cover object-top" />
                </div>
                ...
                <h3 className="text-2xl font-black text-[#772424] mb-4">Methods of Diagnosis</h3>
                <div className="space-y-4 ml-2 mb-6">
                  <div>
                    <div className="flex items-center gap-2 font-black text-[#772424] text-lg mb-1"><span>•</span><h4>Blood test</h4></div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 font-black text-[#772424] text-lg mb-1"><span>•</span><h4>Scalp analysis</h4></div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 font-black text-[#772424] text-lg mb-1"><span>•</span><h4>Pull Test</h4></div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 font-black text-[#772424] text-lg mb-1"><span>•</span><h4>Biopsy</h4></div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 font-black text-[#772424] text-lg mb-1"><span>•</span><h4>Phototrichogram</h4></div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-14">
                ...
                {/* IMAGE 4: Macro Scalp Grafts Close Up (Capture image_1ae5f7.jpg: Macro close up K.C. 27) */}
                <div className="w-full aspect-[16/10] rounded-3xl overflow-hidden bg-gray-100 relative mb-8 shadow-md">
                  <img src="/blog/kc-scalp-grafts.jpg" alt="Macro close up view of delicate female follicular units K.C., 27 years old, 2400 grafts" className="w-full h-full object-cover object-center" />
                </div>
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Medical Interventions</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Low Laser Treatment & Mesotherapy</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-[#772424] mb-2">Hair Transplantation Using FUE</h3>
              ...
              {/* Section: What We Can Provide for You (ZERO LOGISTICS LINES / PURE PKR TIERS) */}
              ...
              <div className="bg-[#772424] text-white rounded-3xl p-8 shadow-2xl relative w-full border border-[#8c2a2a]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <input type="checkbox" id="fhlPrivacy" required defaultChecked className="w-4 h-4 accent-[#C5A059] rounded cursor-pointer" />
                    <label htmlFor="fhlPrivacy" className="text-xs text-white/80 cursor-pointer">
